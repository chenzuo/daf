    ...
    public partial class Init : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        BizFlow_FlowId = c.String(maxLength: 50),
                    })
                ...
                .ForeignKey("dbo.wf_BizFlow", t => t.BizFlow_FlowId)
                .Index(t => t.FlowId)
                .Index(t => t.NextFlowId)
                .Index(t => t.BizFlow_FlowId);
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        PrevTargetStateId = c.String(maxLength: 50),
                ...
                .ForeignKey("dbo.wf_TargetState", t => t.PrevTargetStateId)
                .Index(t => t.TargetFlowId)
                .Index(t => t.OperationId)
                .Index(t => t.StateId)
                .Index(t => t.PrevTargetStateId);
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.wf_TargetState", new[] { "PrevTargetStateId" });
            ...
            DropForeignKey("dbo.wf_TargetState", "PrevTargetStateId", "dbo.wf_TargetState");
