    ...
    public partial class Init : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.cms_Content", t => new { t.SiteId, t.ContentId }, cascadeDelete: false)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.cms_SubSite", t => t.SiteId, cascadeDelete: true)
                .ForeignKey("dbo.cms_PageTemplate", t => new { t.SiteId, t.TemplateName }, cascadeDelete: false)
                .Index(t => t.SiteId)
