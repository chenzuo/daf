...
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
        ...
        return true;
#else
        return DAF.Web.WebHelper.IsAuthenticated;
#endif
	}
	...
	public override void SetConfig()
	{
        ...
        //Domain = DAF.Web.WebHelper.CurrentSite.Domain;
        ...
        type = ResourceType.Add("Vedio");
        type.Url = BaseUrl + "vedio/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "vedio/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "mp4", "mpeg" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add("Audio");
        type.Url = BaseUrl + "audio/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "audio/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "mp3" };
        type.DeniedExtensions = new string[] { };
    }
